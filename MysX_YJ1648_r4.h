...
#define MYSX_D1         26     	//  TX	MYSX_D1_DFM - Digital IO (USART TX (data from MCU)) 
#define MYSX_D2         27     	//  RX	MYSX_D2_DTM - Digital IO (USART RX (data to MCU))
...
#define MYSX_D7         30  	//  D7      A1 ??? SCL
#define MYSX_D8         3  	//  D8      A2 ??? SDA
#define MYSX_D9         31   	//  MYSX_D9_A3 - Digital IO (analog input)
#define MYSX_D10        4   	//  MYSX_D10_A4 - Digital IO (analog input)
//SPI
#define MYSX_D11        15  	//  MYSX_D11_MOSI - Digital IO (SPI MOSI)
#define MYSX_D12        14  	//  MYSX_D12_MISO - Digital IO (SPI MISO)
#define MYSX_D13        13  	//  MYSX_D13_SCK - Digital IO (SPI SCK)
...
//LED pins
#define MYSX_LED_ERR    7
#define MYSX_LED_RX     8
#define MYSX_LED_TX     11


#define MYSX_BUTTON     6
