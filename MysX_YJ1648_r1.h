...
#define MYSX_D5         2   	//  PWM MYSX_D5_PWM - Digital IO (PWM)
#define MYSX_D6         3   	//  MYSX_D6_PWM - Digital IO (PWM)
#define MYSX_D7         15  	//  D7      A1 ???
#define MYSX_D8         14  	//  D8      A2 ???
#define MYSX_D9         30   	//  MYSX_D9_A3 - Digital IO (analog input)
#define MYSX_D10        31   	//  MYSX_D10_A4 - Digital IO (analog input)
//SPI
#define MYSX_D11        18  	//  MYSX_D11_MOSI - Digital IO (SPI MOSI)
#define MYSX_D12        17  	//  MYSX_D12_MISO - Digital IO (SPI MISO)
#define MYSX_D13        20  	//  MYSX_D13_SCK - Digital IO (SPI SCK)
#define MYSX_D14        19  	//  MYSX_D14_CS - Digital IO (also for SPI CS)
